! function() {
  ...
  function m(t) {
    function e() {
      ...
      b("Capturer start"), j = window.Date.now(), C = j + B.startTime, I = window.performance.now(), q = I + B.startTime, window.Date.prototype.getTime = function() {
        ...
        for (var e = 0; e < E.length; e++) E[e] != t || (E.splice(e, 1), b("Timeout cleared"))
    ...
    function f(t) {
      ...
      for (var e = 0; e < U.length; e += 4) U[e] += _.data[e], U[e + 1] += _.data[e + 1], U[e + 2] += _.data[e + 2];
      A++
    }

    function w() {
      for (var t = _.data, e = 0; e < U.length; e += 4) t[e] = 2 * U[e] / B.motionBlurFrames, t[e + 1] = 2 * U[e + 1] / B.motionBlurFrames, t[e + 2] = 2 * U[e + 2] / B.motionBlurFrames;
      V.putImageData(_, 0, 0), O.add(H), R++, A = 0, b("Full MB Frame! " + R + " " + C);
      for (var e = 0; e < U.length; e += 4) U[e] = 0, U[e + 1] = 0, U[e + 2] = 0;
      gc()
    }
    ...
    function g() {
      ...
      for (var i = 0; i < E.length; i++) C >= E[i].triggerTime && (o(E[i].callback), E.splice(i, 1));
      for (var i = 0; i < L.length; i++) C >= L[i].triggerTime && (o(L[i].callback), L[i].triggerTime += L[i].time);
    ...
    var U, _, H = document.createElement("canvas"),
      V = H.getContext("2d");
  ...
  var d = {
    ...
    u = (parseFloat, parseInt, d[typeof exports] && exports && !exports.nodeType ? exports : void 0),
  ...
  }, (g || y || {}).CCapture = m, "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
    return m
